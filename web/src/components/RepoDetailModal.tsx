                ...
                {details.suggestedBackups.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {details.suggestedBackups.map((candidate, idx) => (
                      <div
                        key={idx}
                        className="p-4 rounded-xl bg-[#090d18] border border-slate-800/90 hover:border-indigo-500/40 transition-all space-y-2"
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-300 border border-emerald-500/30">
                        ...
                        <div className="flex items-center justify-between text-[10px] text-slate-400 border-t border-slate-800/80 pt-2">
                          ...
                          <span>
                            Capacity: <strong className="text-cyan-300">{candidate.capacityScore}%</strong>
                          </span>
                        </div>
                      </div>
                    ))}
